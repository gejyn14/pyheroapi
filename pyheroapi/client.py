...
class KiwoomClient:
    ...
    def get_account_balance(self, account_number: str) -> AccountBalance:
        ...
        raise NotImplementedError(
            "Account APIs require additional authentication setup"
        )
    ...
    def get_market_status(self) -> Dict[str, Any]:
        ...
        return {"status": "unknown", "note": "Market status API not implemented"}
    ...
    def buy_stock(
        ...
        response = self._make_request(
            "/api/dostk/ordr", "kt10000", order_data.model_dump()
        )
    ...
    def sell_stock(
        ...
        response = self._make_request(
            "/api/dostk/ordr", "kt10001", order_data.model_dump()
        )
        return OrderResponse(**response)
    ...
    def modify_order(
        ...
        response = self._make_request(
            "/api/dostk/ordr", "kt10002", modify_data.model_dump()
        )
    ...
    def cancel_order(
        ...
        response = self._make_request(
            "/api/dostk/ordr", "kt10003", cancel_data.model_dump()
        )
    ...
    def buy_stock_credit(
        ...
        response = self._make_request(
            "/api/dostk/ordr", "kt10006", order_data.model_dump()
        )
        return OrderResponse(**response)
    ...
    def sell_stock_credit(
        ...
        response = self._make_request(
            "/api/dostk/ordr", "kt10007", order_data.model_dump()
        )
        return OrderResponse(**response)
    ...
    def modify_order_credit(
        ...
        response = self._make_request(
            "/api/dostk/ordr", "kt10008", modify_data.model_dump()
        )
        return ModifyOrderResponse(**response)
    ...
    def cancel_order_credit(
        ...
        response = self._make_request(
            "/api/dostk/ordr", "kt10009", cancel_data.model_dump()
        )
        return CancelOrderResponse(**response)
