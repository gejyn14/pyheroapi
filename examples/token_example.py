...
def token_management_example():
    ...
    try:
        ...
        client = KiwoomClient(access_token=token_response.token, is_production=False)
...
if __name__ == "__main__":
    ...
    print(
        "Note: Make sure to set KIWOOM_APP_KEY and KIWOOM_SECRET_KEY environment variables"
    )
